...
c = 1.
n = 10.
unpickled = myunpickle("../data/20200605_164008/offshore_full_country_10y_min.p")
...
#x_sol, y_sol = solve_IP(D, c, n, "Gurobi", 3600., 0.005)
...
#  x_sol_SALS[r, :], LB_sol_SALS[r], obj_sol_SALS[r, :] = simulated_annealing_local_search(D, c, n, N, I, E, x_init, T_init)
...
#boxplot(["Relaxation + Simulated Annealing Local Search" "Relaxation + Greedy Local Search"], [LB_sol_SALS LB_sol_GLS], title="Performance of Approximation Algorithms (partitioned, max. norm., L=454, n=38, c=38, W=43824)")
#boxplot!(ylabel="Objective Value")

#plot([i for i=1:I], obj_sol_GLS[1, :], title="Performance of Approximation Algorithms (partitioned, max.norm., L=454, n=38, c=38, W=43824)", color="red", label="MILP Relaxation + Greedy Local Search", legend=:bottomright)
#plot!([i for i=1:I], obj_sol_GLS[2:R, :]', color="red", label="", legend=:bottomright)
#plot([i for i=1:I], obj_sol_SALS[1, :], title="Performance of Approximation Algorithm (partitioned, max.norm., L=454, n=38, c=38, W=43824)", color="blue", label="MILP Relaxation + Simulated Annealing Local Search", legend=:bottomright)
...
#filename = "../output/output_5y_runs_090620/offshore_country_5y_max_SALS_n38_c38.p"
